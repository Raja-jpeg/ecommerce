...
module.exports.signup = async (req, res,next) => {
  try {
    ...
    if (user) {
      ...
      //generate conformarion token for email verification and save it to the database
      const token = saved_user.generateConfirmationToken();

      //validateBeforeSave: false is used to avoid the validation of the required fields
      ...
      const mailData = {
        ...
        <p>Verify your email address to complete the signup and login into your <strong>hamart</strong> account.</p>
          ...
          <p style="margin-top: 35px;">If you did not initiate this request, please contact us immediately at support@vakker.com</p>
  
          <p style="margin-bottom:0px;">Thank you</p>
          <strong>Vakker Team</strong>
           `,
      };
      ...
      sendEmail(mailData)
        .then(() => {
          ...
          res.status(200).send({ message: "Please check your email to verify!" });
        })
        .catch((error) => {
